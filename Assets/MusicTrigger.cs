...
{
    public AudioSource musicSource; // La musique � jouer
    public float fadeDuration = 1.0f; // Dur�e du fade in/out
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            Debug.Log("Joueur entr� dans la zone, activation de la musique");
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            Debug.Log("Joueur sorti de la zone, d�sactivation de la musique");
            if (fadeCoroutine != null)
                StopCoroutine(fadeCoroutine);
